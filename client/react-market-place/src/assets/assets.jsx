...
import { Heart, Star, Music, Share2, Zap, Link, Bookmark, Camera, Play, Send } from 'lucide-react';
...
export const platformIcons = {
    ...
    twitter: <Star color='#1DA1F2' className='bg-[#1DA1F210] size-10 p-2 rounded' />,
    linkedin: <Link color='#0077B5' className='bg-[#0077B510] size-10 p-2 rounded' />,
    pinterest: <Bookmark color='#E60023' className='bg-[#E6002310] size-10 p-2 rounded' />,
    snapchat: <Camera color='#FFFC00' className='bg-[#FFFC0010] size-10 p-2 rounded' />,
    twitch: <Zap color='#9146FF' className='bg-[#9146FF10] size-10 p-2 rounded' />,
    discord: <Send color='#5865F2' className='bg-[#5865F210] size-10 p-2 rounded' />,
};
